...
<body>
    ...
    <!-- Category Content Starts Here -->
    <div class="container">
        <h2 class="text-center my-3 mb-4">iForum - Browse Categories</h2>
        <!-- Cards Start Here -->
        <div class="container">
            <div class="row">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    $catDescription = $row['cat_desc'];

                    echo ' <div class="col-md-4 my-3">
                                <div class="card" style="width: 18rem;">
                                    <img src="https://source.unsplash.com/200x100/?'. $catName .',coding" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title"><a href="threadslist.php?catid=' . $id .'">'. $catName .'</a></h5>
                                        <p class="card-text">'. substr($catDescription,0,100) .'...</p>
